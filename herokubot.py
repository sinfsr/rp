...
def echo(bot, update):
    ...
    try:
        ...
        time.sleep(2)
        element1.click()  
        element2 = driver.find_element(By.XPATH , '/html/body/div[7]/div[3]/div[1]/div[1]')
        update.effective_message.reply_text("5")
        time.sleep(2)
        element2.click()
        elememt3 = driver.find_element_by_link_text("فیلتر شماره 0")
        update.effective_message.reply_text("5")
        time.sleep(2)
        elememt3.click()
        elememt4 = driver.find_element(By.XPATH , '/html/body/div[7]/div[3]/div[2]/textarea')
        time.sleep(2)
        elememt4.click()
        ...
        elememt5 = driver.find_element_by_link_text("ثبت")
        time.sleep(2)
        elememt5.click()
